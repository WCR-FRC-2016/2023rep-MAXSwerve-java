...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kFastSpeedMetersPerSecond = 3.0;
    public static final double kLowSpeedMetersPerSecond = 1.0;
    ...
    public static final double kWheelBase = 0.665;//Units.inchesToMeters(26.5);
